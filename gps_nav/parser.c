...
/*int main(){
	  char* buffer="$GPRMC,053740.000,A,2503.6319,N,12136.0099,E,2.69,79.65,100106,,,A*53";
	  //split(buffer);
	  struct point* position = parser(buffer);
	  printf("lat: %f  lon: %f", position->lat, position->lon);
