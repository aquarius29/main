...
gcc `pkg-config --cflags libavformat libavcodec libavutil` -c network.c -o network.o
gcc `pkg-config --libs libavformat libavcodec libavutil` -o v4l-test v4l-test.o encode.o network.o
