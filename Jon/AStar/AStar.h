...
void AddNeighborsToOpen(node * current, nodeList * open, nodeList * closed, int8_t map[][MAP_X], const position * end);
...
int32_t GetHeuristicCost(const position * currentNode, const position * goalNode);
