...
void test_astar_1() {
    ...
    CU_ASSERT(projectedPath.list[4].lat == 378);
    CU_ASSERT(projectedPath.list[5].lon == 594);
    CU_ASSERT(projectedPath.list[5].lat == 486);
    CU_ASSERT(projectedPath.list[6].lon == 702);
    CU_ASSERT(projectedPath.list[6].lat == 594);
    CU_ASSERT(projectedPath.list[7].lon == 810);
    CU_ASSERT(projectedPath.list[7].lat == 594);
    CU_ASSERT(projectedPath.list[8].lon == 918);
    CU_ASSERT(projectedPath.list[8].lat == 594);
...
//     b.x = 10;
//     b.y = 5;    
//     projectedPath = indoor_astar(&a, &b);
//     
