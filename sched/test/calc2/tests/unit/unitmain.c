...
int main(void) {
 ...
 if(NULL == CU_add_test(pSuite1, "Test case 3", testCase3)
	...
	if(NULL == CU_add_test(pSuite1, "Test case 6", testCase6)
		// || NULL == CU_add_test(pSuite1, ...[next test case]...)
		) {
	 	CU_cleanup_registry();
    return CU_get_error();
	...
	if(NULL == CU_add_test(pSuite1, "Test case 7", testCase7)
		// || NULL == CU_add_test(pSuite1, ...[next test case]...)
		) {
	 	CU_cleanup_registry();
    return CU_get_error();
	...
	if(NULL == CU_add_test(pSuite1, "Test case 8", testCase8)
		// || NULL == CU_add_test(pSuite1, ...[next test case]...)
		) {
	 	CU_cleanup_registry();
    return CU_get_error();
	...
	if(NULL == CU_add_test(pSuite1, "Test case 9", testCase9)
		// || NULL == CU_add_test(pSuite1, ...[next test case]...)
		) {
	 	CU_cleanup_registry();
    return CU_get_error();
	...
	if(NULL == CU_add_test(pSuite1, "Test case 10", testCase10)
		// || NULL == CU_add_test(pSuite1, ...[next test case]...)
		) {
	 	CU_cleanup_registry();
    return CU_get_error();
	...
	if(NULL == CU_add_test(pSuite1, "Test case 11", testCase11)
		// || NULL == CU_add_test(pSuite1, ...[next test case]...)
		) {
	 	CU_cleanup_registry();
    return CU_get_error();
	...
	if(NULL == CU_add_test(pSuite1, "Test case 12", testCase12)
		// || NULL == CU_add_test(pSuite1, ...[next test case]...)
		) {
	 	CU_cleanup_registry();
    return CU_get_error();
