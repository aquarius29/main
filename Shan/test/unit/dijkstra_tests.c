...
void test_dijkstra_1() {
    ...
    b.x = 9;
    b.y = 5;    
    projected_path = indoor_dijkstra(&a, &b);
    ...
    CU_ASSERT(projected_path.list[4].lat == 270);
    CU_ASSERT(projected_path.list[5].lon == 594);
    CU_ASSERT(projected_path.list[5].lat == 378);
    CU_ASSERT(projected_path.list[6].lon == 702);
    CU_ASSERT(projected_path.list[6].lat == 486);
    CU_ASSERT(projected_path.list[7].lon == 810);
    CU_ASSERT(projected_path.list[7].lat == 486);
    CU_ASSERT(projected_path.list[8].lon == 918);
    CU_ASSERT(projected_path.list[8].lat == 486);
